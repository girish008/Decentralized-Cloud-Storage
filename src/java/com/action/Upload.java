...
public class Upload extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String keyword = "";
            String cd = "";
            String a = (String) request.getSession().getAttribute("t1");
                    ...
                    while (it.hasNext()) {
                        ...
                        if (isFormField) {
                            ...
                            try {
                                ...
                                pstm = con.prepareStatement("insert into files (id,file, keyword, filetype, filename, CDate, owner, size, data, frank, file_key,status)values(null,?,?,?,?,?,?,?,?,?,?,'Waiting')");
                                ...
                                if (i == 1) {
                                    response.sendRedirect("OwnerHome.jsp?msg1=success");
                                } else {
                                    response.sendRedirect("OwnerHome.jsp?msgg=failed");
                                }
                                con.close();
                            } catch (Exception e) {
